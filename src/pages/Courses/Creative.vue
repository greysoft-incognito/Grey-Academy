  ...
  <div class="hero text-white">
    <div class="hero-writings q-my-auto">
      ...
      <div class="text-justify text-subtitle1">
        The Grey Academy creative school is designed to help enthusiasts
...
.hero {
  /* height: 35vh; */
  padding: 2% 8%;
  background-image: url("/Images/Creative/createmain.png");
...
.course {
  ...
  background-image: url("/Images/Creative/create_bg.png");
  background-position: center;
